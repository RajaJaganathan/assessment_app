...
class CreateQuestionBank extends Component {
  constructor(props) {
    super(props);
  ...
  handleCreateQuestionBank() {
    this.props.onCreateQuestionBank(this.state);
  }
      ...
      <div className="col-xs-6">
        ...
        >
          ...
          <Modal.Footer>
            ...
            <Button onClick={this.handleCreateQuestionBank}>
...
CreateQuestionBank.propTypes = {
  ...
  onCreateQuestionBank: PropTypes.func,
};

CreateQuestionBank.defaultProps = {
  isEditMode: false,
};
